...
def run(method, filename='data_all'):
    ...
    # data_dir = os.path.join("E:/jupyter_notebook_file/Practice2ML/Practice2ML/week1/EEG/Datasets/", filename)
    data_dir = os.path.join("E:/jupyter_notebook_file/Practice2ML/Practice2ML/week1/EEG/data/Datasets", filename)
